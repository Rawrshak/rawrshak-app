...
interface IContentSubsystemBaseInterface extends ethers.utils.Interface {
  functions: {
...
export class IContentSubsystemBase extends BaseContract {
  ...
  interface: IContentSubsystemBaseInterface;
